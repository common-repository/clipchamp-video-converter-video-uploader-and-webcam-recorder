...
Clipchamp is unique insofar as it compresses and converts user-generated videos on the user device into one of the supported video formats (MP4, WebM, ASF, FLV) before files get uploadd to you. The videos your users record get submitted directly from their devices to an upload target you choose without any detours through our servers for better privacy protection - we [never have access](https://help.clipchamp.com/api-and-wordpress-plugin/api-features/does-clipchamp-have-access-to-my-users-videos) to your users' videos.
...
For additional setup tips and more information please refer to [our help centre article](https://help.clipchamp.com/api-and-wordpress-plugin/wordpress-plugin/how-to-install-the-video-uploader-webcam-recorder-wordpress-plugin).
...
1. Add a recording button in the default WordPress editor.
1. Preview of a video recording & uploading button in Gravity Forms.
1. Users can submit an existing video or record on the spot.
1. Uploading an existing video.
1. Add a recording button in the new Gutenberg editor.
1. Sample of the plugin's settings screen.

== Changelog ==

= 1.6.7 =
* Improved error handling when connecting Clipchamp account

= 1.6.6 =
* Reintroduced Before and After Create Hooks
* Minor improvements and fixes

= 1.6.5 =
* Security Update
* Plugin now compliant with WP coding standards

= 1.6.4 =
* Fixed another issue with the Gravity Forms integration

= 1.6.3 =
* Added missing gravityforms.js
...
* Added support for new Gutenberg editor
* Improved account management through WordPress plugin
