<?php $sub = $_POST['subscription']; // CSRF okay. Form data from external URL. ?>
<?php if ( $sub ) : ?>
<script type="text/javascript">
	var subscription = JSON.parse( '<?php echo $sub; // XSS okay. JSON.parse escapes this sufficiently. ?>' );
</script>
<?php endif; ?>
<div class="welcome">
	<header class="header header--welcome">
		<img class="header__image" src="<?php echo esc_url( plugins_url( 'images/logo_colored.png', dirname( __FILE__ ) ) ); ?>" />
	...
	<div class="getting-started">
		...
		<div class="step" id="step1">
			...
			<div class="alert alert--error" id="wrongPlan">
				<p class="alert__message">You already have a non-API account at clipchamp.com. Please <a href="https://help.clipchamp.com/about-products-subscriptions/about-clipchamp/how-can-i-contact-you/">contact us</a> if you'd like to trial the API & WordPress plugin.</p>
			</div>
			...
			<a href="#" onclick="window.open('https://login.clipchamp.com?title=Login / Sign Up&plan=enterprise&redirect=<?php echo rawurlencode( $actual_link ); ?>')" class="button button-primary">Link your Clipchamp account</a>
			<p>All free trial accounts get access to all <a href="https://util.clipchamp.com/en/developers" target="_blank">API features</a>. Please see our API's <a href="https://clipchamp.com/en/pricing/api-access" target="_blank">pricing page</a> for all available plans and pricing options at the end of the trial.</p>
		</div>
		<div class="step" id="step2" style="display: none;">
			...
			<a id="configureAPI" href="https://util.clipchamp.com/en/api-setup" target="_blank" class="button button-primary">Configure your API settings</a>
		</div>
	...
	<p>If you need a more detailed explanation, <a href="https://help.clipchamp.com/api-and-wordpress-plugin/wordpress-plugin/how-to-install-the-video-uploader-webcam-recorder-wordpress-plugin" target="_blank">check out our help centre article</a>.</p>
	<?php else : ?>
	<?php endif; ?>
</div>
